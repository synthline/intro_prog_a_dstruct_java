...
// this is a checked exception now :D
    ...
    public void removeDetails(String key) {
      ...
      // proper code if (details != null) - so the idea is that you have to write code like : even thoguh the detail is null...still run the code!
      //new method header: public void removeDetails( String key) throws NullPointer exception --- i think
