 ...
 * to the address book, and a text interface is provided.
 * 
...
public class AddressBookDemo {
    ...
    /**
     * Setup an AddressBook with sample data. The address book is passed to a GUI to
     * provide a view of the data.
     */
    public AddressBookDemo() {
        ContactDetails[] sampleDetails = { new ContactDetails("david", "08459 100000", "address 1"),
    ...
    public static void main(String[] args) {
        AddressBookDemo a1 = new AddressBookDemo();
