...
public class ProfanityFilterTheThird {
    ...
    public static void main(final String[] args)
  {
    HashMap<String, String> filterMap = new HashMap<>();
     ...
     var M = scan.nextLine().toLowerCase();
      ...
      String[] cussingWords = M.split(" "); //fuck dog 
    ...
    /*     String [] lowerCaseSentence = O.split("\\b"); */
       /*  ArrayList<String> tempSentenceArray = new ArrayList<>(); */
        ...
        for (String word : sentence) 
        {
            ...
            {
                if (word.toLowerCase().equals(keyString))
                { 
                sentenceArray.add(sentenceArray.indexOf(word), filterMap.get(keyString)); 
                sentenceArray.remove(sentenceArray.indexOf(word));    
                }
            }
